	...
	countries: [
		...
		},
		{
			name: {
				...
				native: { sqi: { official: 'Republika e Shqipërisë', common: 'Shqipëria' } },
			},
			tld: ['.al'],
			cca2: 'AL',
			ccn3: '008',
		...
		},
		{
			name: {
				...
				native: { hye: { official: 'Հայաստանի Հանրապետություն', common: 'Հայաստան' } },
			},
			tld: ['.am'],
			cca2: 'AM',
			ccn3: '051',
		...
		},
		{
			name: {
				...
				native: { eng: { official: 'Antigua and Barbuda', common: 'Antigua and Barbuda' } },
			},
			tld: ['.ag'],
			cca2: 'AG',
			ccn3: '028',
		...
		},
		{
			name: {
				...
				native: { eng: { official: 'Commonwealth of Australia', common: 'Australia' } },
			},
			tld: ['.au'],
			cca2: 'AU',
			ccn3: '036',
		...
		},
		{
			name: {
				...
				native: { fra: { official: 'République du Burkina', common: 'Burkina Faso' } },
			},
			tld: ['.bf'],
			cca2: 'BF',
			ccn3: '854',
		...
		},
		{
			name: {
				...
				native: { ben: { official: 'বাংলাদেশ গণপ্রজাতন্ত্রী', common: 'বাংলাদেশ' } },
			},
			tld: ['.bd'],
			cca2: 'BD',
			ccn3: '050',
		...
		},
		{
			...
			area: 765,
			flag: '🇧🇭',
			demonyms: { eng: { f: 'Bahraini', m: 'Bahraini' }, fra: { f: 'Bahreïnienne', m: 'Bahreïnien' } },
		},
		{
			name: {
				common: 'Bahamas',
				official: 'Commonwealth of the Bahamas',
				native: { eng: { official: 'Commonwealth of the Bahamas', common: 'Bahamas' } },
			},
			tld: ['.bs'],
			cca2: 'BS',
			ccn3: '044',
		...
		},
		{
			name: {
				...
				native: { fra: { official: 'Collectivité de Saint-Barthélemy', common: 'Saint-Barthélemy' } },
			},
			tld: ['.bl'],
			cca2: 'BL',
			ccn3: '652',
		...
		},
		{
			name: {
				...
				native: { por: { official: 'República Federativa do Brasil', common: 'Brasil' } },
			},
			tld: ['.br'],
			cca2: 'BR',
			ccn3: '076',
		...
		},
		{
			name: {
				...
				native: { fra: { official: "République de Côte d'Ivoire", common: "Côte d'Ivoire" } },
			},
			tld: ['.ci'],
			cca2: 'CI',
			ccn3: '384',
		...
		},
		{
			...
			translations: {
				...
				urd: { official: 'جمہوری جمہوریہ کانگو', common: '\nکانگو' },
		...
		},
		{
			name: {
				...
				native: { por: { official: 'República de Cabo Verde', common: 'Cabo Verde' } },
			},
			tld: ['.cv'],
			cca2: 'CV',
			ccn3: '132',
		...
		},
		{
			name: {
				...
				native: { spa: { official: 'República de Costa Rica', common: 'Costa Rica' } },
			},
			tld: ['.cr'],
			cca2: 'CR',
			ccn3: '188',
		...
		},
		{
			name: {
				...
				native: { eng: { official: 'Territory of Christmas Island', common: 'Christmas Island' } },
			},
			tld: ['.cx'],
			cca2: 'CX',
			ccn3: '162',
		...
		},
		{
			...
			area: 264,
			flag: '🇰🇾',
			demonyms: { eng: { f: 'Caymanian', m: 'Caymanian' }, fra: { f: 'Caïmanienne', m: 'Caïmanien' } },
		},
		{
			name: {
				common: 'Cyprus',
		...
		},
		{
			name: {
				...
				native: { deu: { official: 'Bundesrepublik Deutschland', common: 'Deutschland' } },
			},
			tld: ['.de'],
			cca2: 'DE',
			ccn3: '276',
		...
		},
		{
			name: {
				...
				native: { eng: { official: 'Commonwealth of Dominica', common: 'Dominica' } },
			},
			tld: ['.dm'],
			cca2: 'DM',
			ccn3: '212',
		...
		},
		{
			name: {
				...
				native: { spa: { official: 'República Dominicana', common: 'República Dominicana' } },
			},
			tld: ['.do'],
			cca2: 'DO',
			ccn3: '214',
		...
		},
		{
			name: {
				...
				native: { ara: { official: 'الجمهورية الديمقراطية الشعبية الجزائرية', common: 'الجزائر' } },
			},
			tld: ['.dz', 'الجزائر.'],
			cca2: 'DZ',
			ccn3: '012',
		...
		},
		{
			name: {
				...
				native: { amh: { official: 'የኢትዮጵያ ፌዴራላዊ ዲሞክራሲያዊ ሪፐብሊክ', common: 'ኢትዮጵያ' } },
			},
			tld: ['.et'],
			cca2: 'ET',
			ccn3: '231',
			...
			area: 1104300,
			flag: '🇪🇹',
			demonyms: { eng: { f: 'Ethiopian', m: 'Ethiopian' }, fra: { f: 'Éthiopienne', m: 'Éthiopien' } },
		},
		{
			name: {
				common: 'Finland',
		...
		},
		{
			name: {
				...
				native: { eng: { official: 'Falkland Islands', common: 'Falkland Islands' } },
			},
			tld: ['.fk'],
			cca2: 'FK',
			ccn3: '238',
		...
		},
		{
			name: {
				...
				native: { eng: { official: 'Federated States of Micronesia', common: 'Micronesia' } },
			},
			tld: ['.fm'],
			cca2: 'FM',
			ccn3: '583',
		...
		},
		{
			name: {
				common: 'Greenland',
				official: 'Greenland',
				native: { kal: { official: 'Kalaallit Nunaat', common: 'Kalaallit Nunaat' } },
			},
			tld: ['.gl'],
			cca2: 'GL',
			ccn3: '304',
		...
		},
		{
			name: {
				...
				native: { spa: { official: 'República de Guatemala', common: 'Guatemala' } },
			},
			tld: ['.gt'],
			cca2: 'GT',
			ccn3: '320',
		...
		},
		{
			name: {
				...
				native: { eng: { official: 'Co-operative Republic of Guyana', common: 'Guyana' } },
			},
			tld: ['.gy'],
			cca2: 'GY',
			ccn3: '328',
		...
		},
		{
			name: {
				...
				native: { ara: { official: 'المملكة الأردنية الهاشمية', common: 'الأردن' } },
			},
			tld: ['.jo', 'الاردن.'],
			cca2: 'JO',
			ccn3: '400',
		...
		},
		{
			name: {
				...
				native: { lao: { official: 'ສາທາລະນະ ຊາທິປະໄຕ ຄົນລາວ ຂອງ', common: 'ສປປລາວ' } },
			},
			tld: ['.la'],
			cca2: 'LA',
			ccn3: '418',
		...
		},
		{
			name: {
				...
				native: { deu: { official: 'Fürstentum Liechtenstein', common: 'Liechtenstein' } },
			},
			tld: ['.li'],
			cca2: 'LI',
			ccn3: '438',
		...
		},
		{
			name: {
				...
				native: { div: { official: 'ދިވެހިރާއްޖޭގެ ޖުމްހޫރިއްޔާ', common: 'ދިވެހިރާއްޖޭގެ' } },
			},
			tld: ['.mv'],
			cca2: 'MV',
			ccn3: '462',
		...
		},
		{
			name: {
				...
				native: { mkd: { official: 'Република Северна Македонија', common: 'Македонија' } },
			},
			tld: ['.mk'],
			cca2: 'MK',
			ccn3: '807',
		...
		},
		{
			name: {
				...
				native: { mya: { official: 'ပြည်ထောင်စု သမ္မတ မြန်မာနိုင်ငံတော်', common: 'မြန်မာ' } },
			},
			tld: ['.mm'],
			cca2: 'MM',
			ccn3: '104',
		...
		},
		{
			name: {
				...
				native: { por: { official: 'República de Moçambique', common: 'Moçambique' } },
			},
			tld: ['.mz'],
			cca2: 'MZ',
			ccn3: '508',
		...
		},
		{
			name: {
				...
				native: { ara: { official: 'الجمهورية الإسلامية الموريتانية', common: 'موريتانيا' } },
			},
			tld: ['.mr'],
			cca2: 'MR',
			ccn3: '478',
		...
		},
		{
			name: {
				...
				native: { fra: { official: 'Nouvelle-Calédonie', common: 'Nouvelle-Calédonie' } },
			},
			tld: ['.nc'],
			cca2: 'NC',
			ccn3: '540',
		...
		},
		{
			name: {
				...
				native: { eng: { official: 'Federal Republic of Nigeria', common: 'Nigeria' } },
			},
			tld: ['.ng'],
			cca2: 'NG',
			ccn3: '566',
		...
		},
		{
			name: {
				...
				native: { nld: { official: 'Koninkrijk der Nederlanden', common: 'Nederland' } },
			},
			tld: ['.nl'],
			cca2: 'NL',
			ccn3: '528',
		...
		},
		{
			...
			area: 323802,
			flag: '🇳🇴',
			demonyms: { eng: { f: 'Norwegian', m: 'Norwegian' }, fra: { f: 'Norvégienne', m: 'Norvégien' } },
		},
		{
			name: {
				common: 'Nepal',
				official: 'Federal Democratic Republic of Nepal',
				native: { nep: { official: 'नेपाल संघीय लोकतान्त्रिक गणतन्त्र', common: 'नेपाल' } },
			},
			tld: ['.np'],
			cca2: 'NP',
			ccn3: '524',
		...
		},
		{
			...
			area: 75417,
			flag: '🇵🇦',
			demonyms: { eng: { f: 'Panamanian', m: 'Panamanian' }, fra: { f: 'Panaméenne', m: 'Panaméen' } },
		},
		{
			name: {
				common: 'Pitcairn Islands',
				official: 'Pitcairn Group of Islands',
				native: { eng: { official: 'Pitcairn Group of Islands', common: 'Pitcairn Islands' } },
			},
			tld: ['.pn'],
			cca2: 'PN',
			ccn3: '612',
		...
		},
		{
			name: {
				...
				native: { fra: { official: 'Polynésie française', common: 'Polynésie française' } },
			},
			tld: ['.pf'],
			cca2: 'PF',
			ccn3: '258',
		...
		},
		{
			name: {
				...
				native: { ara: { official: 'المملكة العربية السعودية', common: 'العربية السعودية' } },
			},
			tld: ['.sa', '.السعودية'],
			cca2: 'SA',
			ccn3: '682',
		...
		},
		{
			name: {
				...
				native: { nor: { official: 'Svalbard og Jan Mayen', common: 'Svalbard og Jan Mayen' } },
			},
			tld: ['.sj'],
			cca2: 'SJ',
			ccn3: '744',
		...
		},
		{
			name: {
				...
				native: { eng: { official: 'Republic of Sierra Leone', common: 'Sierra Leone' } },
			},
			tld: ['.sl'],
			cca2: 'SL',
			ccn3: '694',
		...
		},
		{
			name: {
				...
				native: { spa: { official: 'República de El Salvador', common: 'El Salvador' } },
			},
			tld: ['.sv'],
			cca2: 'SV',
			ccn3: '222',
		...
		},
		{
			name: {
				...
				native: { ita: { official: 'Serenissima Repubblica di San Marino', common: 'San Marino' } },
			},
			tld: ['.sm'],
			cca2: 'SM',
			ccn3: '674',
		...
		},
		{
			name: {
				...
				native: { eng: { official: 'Republic of South Sudan', common: 'South Sudan' } },
			},
			tld: ['.ss'],
			cca2: 'SS',
			ccn3: '728',
		...
		},
		{
			name: {
				...
				native: { eng: { official: 'Turks and Caicos Islands', common: 'Turks and Caicos Islands' } },
			},
			tld: ['.tc'],
			cca2: 'TC',
			ccn3: '796',
		...
		},
		{
			...
			translations: {
				...
				swe: { official: 'Demokratiska republiken Östtimor', common: 'Östtimor a.k.a. Timor-Leste' },
		...
		},
		{
			name: {
				...
				native: { eng: { official: 'Republic of Trinidad and Tobago', common: 'Trinidad and Tobago' } },
			},
			tld: ['.tt'],
			cca2: 'TT',
			ccn3: '780',
		...
		},
		{
			name: {
				...
				native: { spa: { official: 'República Oriental del Uruguay', common: 'Uruguay' } },
			},
			tld: ['.uy'],
			cca2: 'UY',
			ccn3: '858',
		...
		},
		{
			name: {
				...
				native: { eng: { official: 'United States of America', common: 'United States' } },
			},
			tld: ['.us'],
			cca2: 'US',
			ccn3: '840',
		...
		},
		{
			name: {
				...
				native: { spa: { official: 'República Bolivariana de Venezuela', common: 'Venezuela' } },
			},
			tld: ['.ve'],
			cca2: 'VE',
			ccn3: '862',
		...
		},
		{
			name: {
				...
				native: { eng: { official: 'Virgin Islands', common: 'British Virgin Islands' } },
			},
			tld: ['.vg'],
			cca2: 'VG',
			ccn3: '092',
		...
		},
		{
			name: {
				...
				native: { vie: { official: 'Cộng hòa xã hội chủ nghĩa Việt Nam', common: 'Việt Nam' } },
			},
			tld: ['.vn'],
			cca2: 'VN',
			ccn3: '704',
