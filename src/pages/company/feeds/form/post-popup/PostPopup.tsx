			...
			<div ref={ref} className='bg-white relative rounded-md md:w-6/12'>
				<div className='flex items-center justify-between p-2 px-5 rounded-t-md shadow-sm text-gray-600 text-lg'>
					...
					<GeneralButton
						...
						text={'Post'}
						form={'create-post-form-id'}
						loadingClassName={'w-32 h-10 px-3 py-3 bg-primary rounded-md'}
						link={''}
					/>
				</div>
							...
							<div className='flex flex-col h-full justify-between'>
								<div className='flex flex-col h-full'>
									<div className='flex'>
										...
										/>
										<div className='flex flex-col font-semibold items-start ml-5 text-lg'>
											{company[0].legalName}{' '}
											{/* <button
										type='button'
									...
									<div className='h-full py-5'>
										<FormTextArea
											id='status-id'
											name='status'
											atomClassName={'bg-white resize-none h-full p-3 rounded-md w-full'}
											className='h-full'
											register={register}
											errors={errors}
